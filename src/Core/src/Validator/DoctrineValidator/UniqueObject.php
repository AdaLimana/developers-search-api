...
namespace Core\Validator\DoctrineValidator;
...
/**
 * 
 * Essa classe foi definida par o laminas-mvc
 * mas ela pode muito bem ser usada em um projeto
 * utilizando o mezzio, entao, para nao ter que 
 * installar todas as dependencias do laminas-mvc,
 * o que nao faria sentido, foi feita uma copia da 
 * dessa 
 * 
